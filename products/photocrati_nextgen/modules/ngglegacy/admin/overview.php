...
function ngg_AboutMetaBox()
{
    ?>
    <div id="poststuff">
        <p><?php _e("NextGEN Gallery is one of the most popular WordPress plugins of all time with over 11 million downloads.", 'nggallery'); __(" It is developed and supported by Photocrati Media. We'd like to offer a special thanks to Alex Rabe, who first developed the plugin and maintained it through 2011.", 'nggallery'); ?></p>
